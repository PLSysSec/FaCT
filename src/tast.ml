...
type reg_name = string [@@deriving show] (* only generated by transform *)
...
and expr' =
  ...
  | Declassify of expr
  | Inject of reg_name * statements (* only generated by transform *)
[@@deriving show]
...
and statement' =
  ...
  | RegAssign of reg_name * expr (* only generated by transform *)
[@@deriving show]
