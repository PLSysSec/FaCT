...
\subsubsection*{Statements \hfill \fbox{$\Gm \haspc{\pc} s$}}
\begin{mathpar}
  ...
  { x \notin Dom(\m) \\
    \Gm \has e : \vc{\b,\l,\const} \\\\
    \Gm [ x \aug \vc{\ref{\b},\float{\l},\mut} ] \haspc\pc s }
  { \Gm \haspc\pc \vc{\ref{\b},\mut} x = e ; s }

  \infer[VarDec]
  { x \notin Dom(\m) \\
    \Gm \has e : \vc{\b,\l,\k} \\\\
    \Gm [ x \aug \vc{\ref{\b},\float{\l},\k} ] \haspc\pc s }
  { \Gm \haspc\pc \vc{\ref{\b},\k} x = e ; s }

  \infer[ArrDec]
  { x \notin Dom(\m) \\
    \Gm \has e : \vc{\arr{\b,n},\l,\k} \\\\
    \Gm [ x \aug \vc{\arr{\b,n},\l,\k} ] \haspc\pc s }
  { \Gm \haspc\pc \vc{\arr{\b,n},\l,\k} x = e ; s }
  ...
  { \Gm \has e : \vc{\bool,\l,\k} \\
    ...
    \Gm \haspc{\pc'} s_1 \\
    \Gm \haspc{\pc'} s_2 \\
    \m^* = extract\m[\l](s_1,s_2) \\
    \pc^* = extract\pc[\pc'](s_1,s_2) \\
    \Gm^* \haspc{\pc^*} s }
  { \Gm \haspc\pc \kif e\ \{ s_1 \} \kelse \{ s_2 \} ; s }

  \infer[For]
  { \Gm \has e_1 : \vc{\b,\public,\const} \\
    \Gm \has e_2 : \vc{\b,\public,\const} \\
    \b = \uint* \tor \b = \int* \\
    \text{typecheck $s_1$ somehow???} }
  { \Gm \haspc\pc \kfor \vc{\b} x \kfrom e_1 \kto e_2\ \{ s_1 \} ; s }
