...
\begin{mathpar}
  ...
  { \gramrule{\t}{Type} \\
    \gramitem{\b} \\
    \gramitem{\arr{\b,n}} \\
    \gramitem[$x$ must be $\vc{\uint*,\public,\const}$]{\arr{\b,x}} }
...
\begin{mathpar}
  ...
  \infer[VarDecConst]
  { \S' = \S[x \aug v] }
  { \S,\a,\vc{\t,\const} x = v \sstep \S',\a,\kskip }

  \infer[VarDecMut]
  { \S' = \S[x \aug r] \\
    \a' = \a[r \aug v] \\
    \text{fresh $r$} }
  { \S,\a,\vc{\t,\mut} x = v \sstep \S',\a',\kskip }
  ...
  \infer[IfTrue]
  { v = \ktrue }
  { \S,\a,\kif v\ \{ s_1 \} \kelse \{ s_2 \} \sstep s_1 }

  \infer[IfFalse]
  { v = \kfalse }
  { \S,\a,\kif v\ \{ s_1 \} \kelse \{ s_2 \} \sstep s_2 }

  \infer[ForIter]
  { v_1 < v_2 \\
    v_1' = v_1 + 1 }
  { \S,\a,\kfor \vc{\b} x \kfrom v_1 \kto v_2\ \{ s \}
      \sstep s[x \aug v_1] ; \kfor \vc{\b} x \kfrom v_1' \kto v_2\ \{ s \} }

  \infer[ForEnd]
  { v_1 \geq v_2 }
  { \S,\a,\kfor \vc{\b} x \kfrom v_1 \kto v_2\ \{ s \} \sstep \kskip }

  \infer[Deref]
  { \a(r) = v }
  { \S,\a,\textsc{deref}\ r \estep \S,\a,v }
