...
\begin{mathpar}
  ...
  \infer[True] { } { \G \has true : \vc{bool,\public} } \\
  \infer[False] { } { \G \has false : \vc{bool,\public} }
...
% the supertabular inside \grammar breaks if it is straddling a page boundary
\pagebreak
...
\begin{mathpar}
  ...
  { \gramrule{init}{ArrInit} \\
    \gramitem{\vc{\t,n}\textsc{zeros}} \\
    \gramitem{\vc{\t,n}\textsc{fill}(e)} \\
    \gramitem{\vc{\t,n}x \Rightarrow e} \\
    \gramitem{\textsc{copy}(a)} }
