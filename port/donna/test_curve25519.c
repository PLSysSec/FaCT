...
extern int32_t curve25519_donna(uint8_t mypublic[],
                             uint32_t __mypublic_len,
                             const uint8_t _secret[],
                             uint32_t ___secret_len,
                             const uint8_t basepoint[],
                             uint32_t __basepoint_len);
...
void doit(unsigned char *ek,unsigned char *e,unsigned char *k)
{
  ...
  curve25519_donna(ek, 32, e, 32, k, 32);
