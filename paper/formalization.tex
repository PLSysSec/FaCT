...
The \ccore language is a \textsc{While}-like language with highly limited
...
signed integers and byte-arrays.
...
To prove the constant-time nature of \ccore, we adopt the
...
we can compile any \constc program to a program with the timing guarantees proven in \ccore.
