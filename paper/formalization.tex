...
bitwise \emph{and}, \emph{or}, and \emph{not} operations respectively. The formal transformation is given in \rref{Stt-var-assign}. The
...
statement. This ensures that nested conditionals still function as expected. The formal transformation is given in \rref{Stt-if}.
...
The formal transformation is given in \rref{Stt-ret}.
