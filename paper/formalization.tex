...
programming language, \constc is intended for a very specific domain; a survey of typical functions
indicates these language features are generally unnecessary. As we develop the language, we expect
